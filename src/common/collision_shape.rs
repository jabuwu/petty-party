...
// this madness is from the Real-Time Collision Detection book by Christer Ericson
// someone should let him know that there's a bug if velocity.x == 0 or velocity.y == 0 :)
// the bug is fixed in the code below
